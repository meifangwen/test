<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"D:\thinkphp\public/../application/admin\view\banner\upd.html";i:1559189204;s:43:"../application/admin/view/index/heater.html";i:1559189204;s:43:"../application/admin/view/index/footer.html";i:1558417309;}*/ ?>
...
<link rel="stylesheet" type="text/css" href="<?php echo config('static_admin'); ?>/css/lib/webuploader/webuploader.css"/>
<link rel="stylesheet" type="text/css" href="<?php echo config('static_admin'); ?>/css/H-ui.min.css" />
<link rel="stylesheet" type="text/css" href="<?php echo config('static_admin'); ?>/css/H-ui.admin.css" />

<script type="text/javascript" src="<?php echo config('static_admin'); ?>/js/H-ui.min.js"></script> 
<script type="text/javascript" src="<?php echo config('static_admin'); ?>/js/H-ui.admin.page.js"></script> 
<script type="text/javascript" src="<?php echo config('static_admin'); ?>/css/lib/webuploader/webuploader.min.js"></script> 
<div class="mws-panel grid_7" style="margin-top: 5%;">
    <form class="mws-form" action="<?php echo url('/admin/banner/upd'); ?>" method="post">
                ...
                <div class="mws-form-inline">
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item small">
                            <input type="text" class="mws-textinput" name="title" value="<?php echo $bannerData['title']; ?>"/>
                        </div>
                    </div>
                    <div class="mws-form-row">
                        <label >上传组图：</label>
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <div class="uploader-thum-container">
                                <div id="fileList2" class="uploader-list">
                                    <?php if(!empty($img_path)): foreach($img_path as $v): ?> 
                                    <div class="item editpic  pb-10">
                                        <div class="pic-box" style="background-image:url(/upload/<?php echo $v; ?>)" ></div>
                                        <input type="hidden" name="src[]" value="<?php echo $v; ?>" vid="<?php echo $bannerData['id']; ?>" >
                                        <div class="file-panel">
                                            <span class="cancel"  path="<?php echo $v; ?>" id="<?php echo $bannerData['id']; ?>" >删除</span>
                                        </div>
                                    </div>
