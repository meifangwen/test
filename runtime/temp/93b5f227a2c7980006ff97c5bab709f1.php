<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:60:"D:\thinkphp\public/../application/admin\view\plan\index.html";i:1559270441;s:43:"../application/admin/view/index/heater.html";i:1559286253;s:22:"./data/data_system.php";i:1559190116;s:43:"../application/admin/view/index/footer.html";i:1559286312;}*/ ?>
...
<div class="mws-panel grid_7 " style="margin-top: 5%">
    ...
    <div class="mws-panel-header">
        <span class="mws-i-24 i-table-1">溯源方案</span>
    </div>
    <div class="mws-panel-body">
        <table class="mws-table">
            ...
            <tbody>
                <?php foreach($planData as $v): $i = explode("||",$v["src"]); ?>
                <td><?php echo $v["id"]; ?></td>
                ...
                <td>                       
                    <div class="mws-panel-toolbar top clearfix">
                        <ul>
                            <li><a href="<?php echo url('/admin/plan/upd',['id' => $v['id']]); ?>" class="mws-ic-16 ic-edit">编辑</a></li>
                        </ul>
                    </div>
                </td>
            </tbody>
