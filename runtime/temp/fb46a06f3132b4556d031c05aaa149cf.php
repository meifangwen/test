<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:62:"D:\thinkphp\public/../application/admin\view\system\index.html";i:1559190103;s:43:"../application/admin/view/index/heater.html";i:1559286253;s:22:"./data/data_system.php";i:1559190116;s:43:"../application/admin/view/index/footer.html";i:1559286312;}*/ ?>
...
<div class="mws-panel grid_7" style="margin-top: 5%;">
    <form class="mws-form" action="<?php echo url('/admin/system/index'); ?>" method="post" enctype="multipart/form-data">
         <div class="mws-panel grid_8">
                <div class="mws-panel-header">
                    <span class="mws-i-24 i-list">参数设置</span>
                </div>
                        ...
                        <div class="mws-form-inline">
                            <div class="mws-form-row">
                                ...
                                <div class="mws-form-item small">
                                    <input type="text" class="mws-textinput" name="web_name" value="<?php echo $systemData['web_name']; ?>"/>
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>网站Logo</label>
                                <div class="mws-form-item medium">
                                    <input type="file" class="mws-textinput" name="logo"/>
                                </div>
                            </div>
                            <div class="mws-form-row" style="height: 70px;width: 100%;">
                                <input type="hidden" name="img_path" value="<?php echo $systemData['logo']; ?>" />
                                <div class="pic-box" style="background-image:url(/upload/<?php echo $systemData['logo']; ?>);background-repeat: no-repeat;height: 100px;background-size: 10%;margin-left: 200px;">
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>网站描述</label>
                                <div class="mws-form-item large">
                                    <textarea id="content" name="describe" style="width: 800px;"><?php echo $systemData['describe']; ?></textarea>
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>网站邮箱</label>
                                <div class="mws-form-item medium">
                                    <input type="text" class="mws-textinput" name="email" value="<?php echo $systemData['email']; ?>" />
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>qq</label>
                                <div class="mws-form-item medium">
                                    <input type="text" class="mws-textinput" name="qq" value="<?php echo $systemData['qq']; ?>" />
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>网站联系方式</label>
                                <div class="mws-form-item medium">
                                    <input type="text" class="mws-textinput" name="phone" value="<?php echo $systemData['phone']; ?>" />
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>咨询电话</label>
                                <div class="mws-form-item medium">
                                    <input type="text" class="mws-textinput" name="zx_phone" value="<?php echo $systemData['zx_phone']; ?>" />
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>咨询座机</label>
                                <div class="mws-form-item medium">
                                    <input type="text" class="mws-textinput" name="zx_landline" value="<?php echo $systemData['zx_landline']; ?>" />
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>公司经度</label>
                                <div class="mws-form-item medium">
                                    <input type="text" class="mws-textinput" name="longitude" value="<?php echo $systemData['longitude']; ?>" />
                                </div>
                            </div>
                            <div class="mws-form-row">  
                                <label>公司纬度</label>
                                <div class="mws-form-item medium">
                                    <input type="text" class="mws-textinput" name="latitude" value="<?php echo $systemData['latitude']; ?>" />
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>公司地址</label>
                                <div class="mws-form-item medium">
                                    <input type="text" class="mws-textinput" name="address" value="<?php echo $systemData['address']; ?>" />
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>网站备案号</label>
                                <div class="mws-form-item medium">
                                    <input type="text" class="mws-textinput" name="record" value="<?php echo $systemData['record']; ?>" />
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>网站SEO</label>
                                <div class="mws-form-item medium">
                                    <input type="text" class="mws-textinput" name="seo" value="<?php echo $systemData['seo']; ?>" />
                                </div>
                            </div> 
                            <div class="mws-form-row">
                                <label>网站微信二维码</label>
                                <div class="mws-form-item medium">
                                    <input type="file" class="mws-textinput" name="qrcode" />
                                </div>
                            </div>
                             <div class="mws-form-row" style="height: 70px;width: 100%;">
                                <input type="hidden" name="qrcode_path" value="<?php echo $systemData['qrcode']; ?>" />
                                <div class="pic-box" style="background-image:url(/qrcode/<?php echo $systemData['qrcode']; ?>);background-repeat: no-repeat;height: 100px;background-size: 5%;margin-left: 200px;">
                                </div>
                            </div>
                            ...
                            <div class="mws-form-row">
                                <label>网站微信公众号</label>
                                <div class="mws-form-item medium">
                                    <input type="file" class="mws-textinput" name="wechat_public" />
                                </div>
                            </div>
                             <div class="mws-form-row" style="height: 70px;width: 100%;">
                                <input type="hidden" name="wechat_public" value="<?php echo $systemData['wechat_public']; ?>" />
                                <div class="pic-box" style="background-image:url(/qrcode/<?php echo $systemData['wechat_public']; ?>);background-repeat: no-repeat;height: 100px;background-size: 5%;margin-left: 200px;">
                                </div>
                            </div>
                            ...
                            <div class="mws-form-row">
                                <label>网站微信</label>
                                <div class="mws-form-item medium">
                                    <input type="text" class="mws-textinput" name="wechat" value="<?php echo $systemData['wechat']; ?>" />
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>网站站点关闭</label>
                                <div class="mws-form-item clearfix">
                                    <ul class="mws-form-list inline">
                                        <li><input type="radio"  value="0" name="web_close" <?php echo $systemData["web_close"]==0?"checked" : ""; ?> /><label>开启</label></li>
                                        <li><input type="radio" value="1" name="web_close"  <?php echo $systemData["web_close"]==1?"checked" : ""; ?>/> <label>关闭</label></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>网站站点关闭说明</label>
                                <div class="mws-form-item medium">
                                    <input type="text" class="mws-textinput" name="close_desc" value="<?php echo $systemData['close_desc']; ?>"/>
                                </div>
                            </div>
                        </div>
