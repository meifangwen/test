<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"D:\www.guoan.com\public/../application/admin\view\banner\index.html";i:1559267813;s:43:"../application/admin/view/index/heater.html";i:1559286253;s:22:"./data/data_system.php";i:1559190116;s:43:"../application/admin/view/index/footer.html";i:1559286312;}*/ ?>
...
<form action="<?php echo url('/admin/banner/del'); ?>" method="post">
    ...
    <div class="mws-panel-body">
    	<div class="mws-panel-toolbar top clearfix">
        	<ul>
            	...
            	<li><a href="<?php echo url('/admin/banner/add'); ?>" class="mws-ic-16 ic-add">添加</a></li>
            </ul>
        </div>
        <table class="mws-table">
            ...
            <tbody>
                <?php if(!empty($bannerData)): foreach($bannerData as $v):   ?>  
                <tr class="gradeX">
                    ...
                    <td>
                    <?php $i=explode(",",$v['src']); ?>
                        <a href="/upload/<?php echo $i[0]; ?>" target="black">
                            <img src="/upload/<?php echo $i[0]; ?>" style="width: auto;height: 30px;padding: 1px;">
                        </a>
                    </td>
                    <td class="status"><?php echo $v["is_show"]==0?"已显示":"<span style='color: red;'>不显示</span>"; ?></td>
                    <td><?php echo date("Y-m-d H:i:s",$v["datetime"]); ?></td>
                    <td class="center">
                        <div class="mws-panel-toolbar top clearfix">
                            <ul>
                                <li>
                                    <a href="<?php echo url('/admin/banner/upd',['id' => $v['id']]); ?>" class="mws-ic-16 ic-edit" style="font-size: 12px;">编辑</a>
                                </li>
                                <li class="titles"  onclick="titles(this);" id="<?php echo $v['id']; ?>">
                                    <?php echo $v["is_show"]==0?"<a href='#' class='mws-ic-16 ic-cross' >隐藏</a>" : "<a href='#' class='mws-ic-16 ic-accept'>显示</a>"; ?>
                                </li>
                                <li class="titles" id="<?php echo $v['id']; ?>">
                                    <a href="<?php echo url('/admin/banner/del',['id' => $v['id']]); ?>" class='mws-ic-16 ic-cross'>删除</a>
                                </li>
                            </ul>
                        </div>
                    </td>
...
<script type="text/javascript">
    ...
    function titles(it){
        var id = $(it).attr('id');
        // console.log(id);
        $.get("<?php echo url('/admin/banner/is_show'); ?>",{"id":id},function(e){
            // console.log(e);
            if(e.code==1){
                //1表示封号成功
