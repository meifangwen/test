<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"D:\www.guoan.com\public/../application/admin\view\banner\add.html";i:1559189204;s:43:"../application/admin/view/index/heater.html";i:1559286253;s:22:"./data/data_system.php";i:1559190116;s:43:"../application/admin/view/index/footer.html";i:1559286312;}*/ ?>
...
<div class="mws-panel grid_7" style="margin-top: 5%;">
    <form class="mws-form" action="<?php echo url('/admin/banner/add'); ?>" method="post">
...
$(function(){
  ...
  $(".cancel").click(function(){
      ...
      $.get("<?php echo url('/admin/banner/delpic'); ?>",{"url":url,"id":id},function(e){
          // console.log(e);
          if(e.code==1){
              layer.msg(e.msg);
