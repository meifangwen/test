<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"D:\thinkphp\public/../application/admin\view\messages\index.html";i:1559270647;s:43:"../application/admin/view/index/heater.html";i:1559286253;s:22:"./data/data_system.php";i:1559190116;s:43:"../application/admin/view/index/footer.html";i:1559286312;}*/ ?>
    ...
    <div class="mws-panel-body">
        <table class="mws-table">
            ...
            <tbody>
                ...
                <td  class="onload"><?php echo $v["content"]; ?></td>
                <td ><?php echo $v["status"]==0?"<span style='color: red;'>未回复</span>":"<span style='color: green;'>已回复</span>"; ?></td>
                <td class="status"><?php echo $v["is_show"]==0?"已显示":"<span style='color: red;'>不显示</span>"; ?></td>
                <td>                       
                    <div class="mws-panel-toolbar top clearfix">
                        <ul>
                            <li><a href="<?php echo url('/admin/messages/upd',['id' => $v['id']]); ?>" class="mws-ic-16 ic-edit">编辑</a></li>
                            <li class="titles"  onclick="titles(this);" id="<?php echo $v['id']; ?>">
                                <?php echo $v["is_show"]==0?"<a href='#' class='mws-ic-16 ic-cross' >显示</a>" : "<a href='#' class='mws-ic-16 ic-accept'>隐藏</a>"; ?>
                            </li>
                        </ul>
                    </div>
                </td>
...
<script type="text/javascript">
    ...
    function titles(it){
        var id = $(it).attr('id');
        // console.log(id);
        $.get("<?php echo url('/admin/messages/is_show'); ?>",{"id":id},function(e){
            // console.log(e);
            if(e.code==1){
                //1表示封号成功
