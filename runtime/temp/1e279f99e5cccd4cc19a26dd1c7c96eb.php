<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"D:\www.guoan.com\public/../application/admin\view\index\index.html";i:1559273704;s:43:"../application/admin/view/index/heater.html";i:1559286253;s:22:"./data/data_system.php";i:1559190116;s:43:"../application/admin/view/index/footer.html";i:1559286312;}*/ ?>
...
<div class="mws-panel grid_7 " style="margin-top: 5%">
    <div class="mws-panel-header">
        <span class="mws-i-24 i-table-1">首页内容管理列表</span>
    </div>
    <div class="mws-panel-body">
<!--         <div class="mws-panel-toolbar top clearfix">
            <ul>
                <li><a href="<?php echo url('/admin/news/add'); ?>" class="mws-ic-16 ic-accept">添加</a></li>
            </ul>
        </div> -->
        <table class="mws-table">
            ...
            <tbody>
                <?php foreach($indexData as $v): $i = explode("||",$v["src"]); ?>
                <td><?php echo $v["id"]; ?></td>
                <td><?php echo $v["title"]; ?></td>
                <td style="width: 70px;">
                    <a href="/upload/<?php echo $i[0]; ?>" target="black"><img src="/upload/<?php echo $i[0]; ?>" style="height: 20px;margin-right: 10px;"></a>
                    <a href="/upload/<?php echo $i[1]; ?>" target="black"><img src="/upload/<?php echo $i[1]; ?>" style="height: 20px;"></a>
                </td>
                <td  class="onload"><?php echo cut_str($v["content"],20); ?></td>
                <td>                       
                    <div class="mws-panel-toolbar top clearfix">
                        <ul>
                            <li><a href="<?php echo url('/admin/index/upd',['id' => $v['id']]); ?>" class="mws-ic-16 ic-edit">编辑</a></li>
