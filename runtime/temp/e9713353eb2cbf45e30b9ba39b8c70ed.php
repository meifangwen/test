<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"D:\thinkphp\public/../application/admin\view\trend\index.html";i:1559270403;s:43:"../application/admin/view/index/heater.html";i:1559286253;s:22:"./data/data_system.php";i:1559190116;s:43:"../application/admin/view/index/footer.html";i:1559286312;}*/ ?>
...
<form action="<?php echo url('/admin/trend/del'); ?>" method="post">
<div class="mws-panel grid_7 " style="margin-top: 5%">
    ...
    <div class="mws-panel-header">
        <span class="mws-i-24 i-table-1">溯源趋势</span>
    </div>
    <div class="mws-panel-body">
        <table class="mws-table">
            ...
            <tbody>
                <?php foreach($trendData as $v): $i = explode("||",$v["src"]); ?>
                <td><?php echo $v["id"]; ?></td>
                ...
                <td>                       
                    <div class="mws-panel-toolbar top clearfix">
                        <ul>
                            <li><a href="<?php echo url('/admin/trend/upd',['id' => $v['id']]); ?>" class="mws-ic-16 ic-accept">编辑</a></li>
                        </ul>
                    </div>
                </td>
            </tbody>
