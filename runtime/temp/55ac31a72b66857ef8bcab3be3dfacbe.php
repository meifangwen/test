<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:58:"D:\thinkphp\public/../application/admin\view\team\add.html";i:1559189204;s:43:"../application/admin/view/index/heater.html";i:1559284626;s:43:"../application/admin/view/index/footer.html";i:1558417309;}*/ ?>
...
<div class="mws-panel grid_7" style="margin-top: 5%;">
    <form class="mws-form" action="<?php echo url('/admin/team/add'); ?>" method="post" enctype="multipart/form-data">
         <div class="mws-panel grid_8">
                <div class="mws-panel-header">
                    <span class="mws-i-24 i-plus">添加成员</span>
                </div>
                <div class="mws-panel-body">
                    <div class="mws-form-inline">
                        ...
                        <div class="mws-form-row">
                            <label>职务</label>
                            <div class="mws-form-item small">
                                <input type="text" class="mws-textinput" name="position"/>
                            </div>
                        </div>
                        <div class="mws-form-row">
                            <label>头像</label>
                        ...
                        <div class="mws-form-row">
                            ...
                            <div class="mws-form-item large">
                                <textarea name="content" style="width: 780px;"></textarea>
                            </div>
                        </div>
                    </div>
