<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"D:\thinkphp\public/../application/home\view\index\index.html";i:1559190342;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="module_wrap">
         <div class="module_content ">
          <div class="module_text_content">
           <div class="fkeditor-wrap">
            <div class="fk-editor">
             <div style="font-size: 24px; color: rgb(51, 51, 51); font-family: 微软雅黑; text-align: left;">
              <?php echo $indexData2[0]["title"]; ?>
           ...
           <div class="fkeditor-wrap">
            <div class="fk-editor">
             <div style="line-height: 35px; font-size: 14px; text-align: left;">
              <font face="Microsoft YaHei, 微软雅黑" style="color: rgb(153, 153, 153); font-size: 16px;"><?php echo $indexData2[0]["content"]; ?></font>
             </div>
            </div>
           </div>
          </div>
                        ...
                        <div class="module_wrap">
                            <div class="module_content ">
                                <div class="module_text_content">
                                    <div class="fkeditor-wrap">
                                        <div class="fk-editor">
                                            <div style="text-align: center; font-size: 28px;">我们的团队</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="module_wrap">
                            <div class="module_content ">
                                <div class="module_text_content">
                                    <div class="fkeditor-wrap">
                                        <div class="fk-editor">
                                            <div style="text-align: center; font-size: 14px; color: rgb(153, 153, 153); font-family: 微软雅黑;">CORE TEAM</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div data-id="2" class="news_list_item_line jz_hover jz_theme_font_hover_color news_list_item_line_num news_list_item_line_num2 news_list_item_line_pic">
                                            ...
                                            <div class="news_list_item_inner">
                                                <div class="news_list_img_box">
                                                    <div class="news_list_img" data-was-processed="true" style='background-image: url("/team/<?php echo $v['img']; ?>");'></div>
                                                </div>
                                                <div class="news_list_item_content">
                                                    <div class="news_list_item_header">
                                                        <h4 class="news_list_item_title jz_theme_font_hover_color jz_hover"><?php echo $v['name']; ?></h4> 
                                                        <span class="news_list_item_date"><?php echo $v['position']; ?></span>
                                                    </div> 
                        ...
                        <div class="module_wrap">
                            <div class="module_content ">
                                <div class="module_text_content">
                                    <div class="fkeditor-wrap">
                                        <div class="fk-editor">
                                            <div style="text-align: center; font-size: 28px;">新闻资讯</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="module_wrap">
                            <div class="module_content ">
                                <div class="module_text_content">
                                    <div class="fkeditor-wrap">
                                        <div class="fk-editor">
                                            <div style="text-align: center; font-size: 14px; color: rgb(153, 153, 153); font-family: 微软雅黑;">INFORMATION NEWS</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
          ...
          <div class="module_text_content">
           <div class="fkeditor-wrap">
            <div class="fk-editor">
             <div style="text-align: center; line-height: 36px;"></div>
             <div style="text-align: center; line-height: 36px;">
              <img src="/qrcode/<?php echo $content['wechat_public']; ?>">
             </div>
             <span style="font-size: 14px;"></span>
            </div>
           </div>
