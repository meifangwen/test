<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"D:\thinkphp\public/../application/admin\view\notice\upd.html";i:1559272229;s:43:"../application/admin/view/index/heater.html";i:1559189204;s:43:"../application/admin/view/index/footer.html";i:1558417309;}*/ ?>
...
<div class="mws-panel grid_7" style="margin-top: 5%;">
    <form class="mws-form" action="<?php echo url('/admin/notice/upd'); ?>" method="post" enctype="multipart/form-data">
         <div class="mws-panel grid_8">
                <div class="mws-panel-header">
                    <span class="mws-i-24 i-pencil">编辑公告</span>
                </div>
                <div class="mws-panel-body">
                        <input type="hidden" name="id" value="<?php echo $noticeData['id']; ?>" />
                        <div class="mws-form-inline">
                            <div class="mws-form-row">
                                <label>公告标题</label>
                                <div class="mws-form-item small">
                                    <input type="text" class="mws-textinput" name="title" value="<?php echo $noticeData['title']; ?>"/>
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>公告标题图片</label>
                            ...
                            <div class="mws-form-row" style="height: 100px;width: 100%;">
                                <input type="hidden" name="img_path" value="<?php echo $noticeData['img']; ?>" />
                                <div class="pic-box" style="background-image:url(/news/<?php echo $noticeData['img']; ?>);background-repeat: no-repeat;height: 100px;background-size: 10%;margin-left: 200px;">
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>排序</label>
                                <div class="mws-form-item medium">
                                    <input type="text" class="mws-textinput" name="sort" value="<?php echo $noticeData['sort']; ?>"/>
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>内容</label>
                                <div class="mws-form-item large">
                                    <textarea id="content" name="content"><?php echo $noticeData['content']; ?></textarea>
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>首页显示</label>
                                <div class="mws-form-item clearfix">
                                    <ul class="mws-form-list inline">
                                        <li>
                                            <input type="radio" value="0" name="is_show"  <?php echo $noticeData["is_show"]==0?"checked" : ""; ?> />
                                            <label>显示</label>
                                        </li>
                                        <li>
                                            <input type="radio" value="1" name="is_show" <?php echo $noticeData["is_show"]==1?"checked" : ""; ?> />
                                            <label>不显示</label>
                                        </li>
                                    </ul>
                                </div>
