<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:58:"D:\thinkphp\public/../application/admin\view\plan\upd.html";i:1559189204;s:43:"../application/admin/view/index/heater.html";i:1559189204;s:43:"../application/admin/view/index/footer.html";i:1558417309;}*/ ?>
...
<div class="mws-panel grid_7" style="margin-top: 5%;">
    <form class="mws-form" action="<?php echo url('/admin/plan/upd'); ?>" method="post" enctype="multipart/form-data" >
         <?php $i = explode("||",$planData['src']);$j = explode("||",$planData['title']);$k = explode("||",$planData['content']);$p = explode("||",$planData['part']); ?>
         <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-pencil">编辑</span>
            </div>
            <div class="mws-panel-body"  style="width: 750px; float: left;">
                    <input type="hidden" name="id" value="<?php echo $planData['id']; ?>" />
