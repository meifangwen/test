<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:60:"D:\thinkphp\public/../application/admin\view\team\index.html";i:1559207130;s:43:"../application/admin/view/index/heater.html";i:1559286253;s:22:"./data/data_system.php";i:1559190116;s:43:"../application/admin/view/index/footer.html";i:1559286312;}*/ ?>
...
<form action="<?php echo url('/admin/team/del'); ?>" method="post">
    ...
    <div class="mws-panel-body">
    	<div class="mws-panel-toolbar top clearfix">
        	<ul>
            	...
            	<li><a href="<?php echo url('/admin/team/add'); ?>" class="mws-ic-16 ic-add">添加</a></li>
            </ul>
        </div>
        <table class="mws-table">
            ...
            <tbody>
                ...
                <tr class="gradeX">
                    ...
                    <td ><img src="/team/<?php echo $v['img']; ?>" style="height: 40px;"></td>
                    <td><?php echo $v["content"]; ?></td>
                    <td class="center">
                    	<div class="mws-panel-toolbar top clearfix">
                    	    <ul>
                            	<li>
                                    <a href="<?php echo url('/admin/team/upd',['id' => $v['id']]); ?>" class="mws-ic-16 ic-edit" >编辑</a>
                                </li>
                            	<li class="titles" id="<?php echo $v['id']; ?>">
                                   <a href="<?php echo url('/admin/team/del',['id' => $v['id']]); ?>" class='mws-ic-16 ic-cross'>删除</a>
                                </li>
                            </ul>
                        </div>
                    </td>
