<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:58:"D:\thinkphp\public/../application/admin\view\user\add.html";i:1559274433;s:43:"../application/admin/view/index/heater.html";i:1559286253;s:22:"./data/data_system.php";i:1559190116;s:43:"../application/admin/view/index/footer.html";i:1559286312;}*/ ?>
...
<div class="mws-panel grid_7" style="margin-top: 5%;">
	<div class="mws-panel-header">
    	<span class="mws-i-24 i-plus">添加管理员</span>
    </div>
    <div class="mws-panel-body">
    	<form class="mws-form" action="<?php echo url('/admin/user/add'); ?>" method="post">
