<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:59:"D:\thinkphp\public/../application/admin\view\index\upd.html";i:1559189204;s:43:"../application/admin/view/index/heater.html";i:1559286253;s:22:"./data/data_system.php";i:1559190116;s:43:"../application/admin/view/index/footer.html";i:1559286312;}*/ ?>
...
<div class="mws-panel grid_7" style="margin-top: 5%;">
    <form class="mws-form" action="<?php echo url('/admin/index/upd'); ?>" method="post" enctype="multipart/form-data" >
         <?php $i = explode("||",$indexData['src']);$j = explode("||",$indexData['title']);$k = explode("||",$indexData['content']); ?>
         <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-pencil">编辑首页</span>
            </div>
            <div class="mws-panel-body"  style="width: 750px; float: left;">
                    <input type="hidden" name="id" value="<?php echo $indexData['id']; ?>" />
                    <div class="mws-form-inline">
                        <div class="mws-form-row">
                            <label>板块</label>
                            <div class="mws-form-item small">
                                <input type="text" class="mws-textinput" name="part[]" value="<?php echo $indexData['part']; ?>" disabled="disabled" />
                            </div>
                        </div>
                        <div class="mws-form-row">
                            <label>标题</label>
                        ...
                        <div class="mws-form-row">
                            ...
                            <div class="mws-form-item medium">
                                <input type="file" class="mws-textinput" name="src"/>
                            </div>
                        </div>
                        <div class="mws-form-row" style="height: 100px;width: 100%;">
                            <input type="hidden" name="img_path[]" value="<?php echo $i[0]; ?>" />
                            <div class="pic-box" style="background-image:url(/upload/<?php echo $i[0]; ?>);background-repeat: no-repeat;height: 100px;background-size: 10%;margin-left: 200px;">
                            </div>
                        </div>
                        <div class="mws-form-row">
                            <label>内容</label>
                ...
                <div class="mws-panel-body" style="width: 750px; float: right;">
                    <div class="mws-form-inline">
                        ...
                        <div class="mws-form-row" style="height: 100px;width: 100%;">
                            ...
                            <div class="pic-box" style="background-image:url(/upload/<?php echo $i[1]; ?>);background-repeat: no-repeat;height: 100px;background-size: 10%;margin-left: 200px;">
                            </div>
                        </div>
                        <div class="mws-form-row">
                            <label>英文内容</label>
