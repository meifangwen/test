<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:60:"D:\thinkphp\public/../application/admin\view\news\index.html";i:1559207160;s:43:"../application/admin/view/index/heater.html";i:1559286253;s:22:"./data/data_system.php";i:1559190116;s:43:"../application/admin/view/index/footer.html";i:1559286312;}*/ ?>
...
<form action="<?php echo url('/admin/news/del'); ?>" method="post">
    ...
    <div class="mws-panel-body">
    	<div class="mws-panel-toolbar top clearfix">
        	<ul>
            	...
            	<li><a href="<?php echo url('/admin/news/add'); ?>" class="mws-ic-16 ic-add">添加</a></li>
            </ul>
        </div>
        <table class="mws-table">
            ...
            <tbody>
                ...
                <tr class="gradeX">
                    ...
                    <td ><img src="/news/<?php echo $v['img']; ?>" style="height: 40px;"></td>
                    ...
                    <td class="center">
                    	<div class="mws-panel-toolbar top clearfix">
                    	    <ul>
                            	<li><a href="<?php echo url('/admin/news/upd',['id' => $v['id']]); ?>" class="mws-ic-16 ic-edit" >编辑</a></li>
                            	...
                            	<li class="titles" id="<?php echo $v['id']; ?>">
                                   <a href="<?php echo url('/admin/news/del',['id' => $v['id']]); ?>" class='mws-ic-16 ic-cross'>删除</a>
                                </li>
                            </ul>
                        </div>
                    </td>
...
<script type="text/javascript">
    ...
    function titles(it){
        var id = $(it).attr('id');
        // console.log(id);
        $.get("<?php echo url('/admin/news/is_show'); ?>",{"id":id},function(e){
            // console.log(e);
            if(e.code==1){
                //1表示封号成功
