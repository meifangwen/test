<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:58:"D:\thinkphp\public/../application/admin\view\user\upd.html";i:1559273365;s:43:"../application/admin/view/index/heater.html";i:1559286253;s:22:"./data/data_system.php";i:1559190116;s:43:"../application/admin/view/index/footer.html";i:1559286312;}*/ ?>
...
<div class="mws-panel grid_7" style="margin-top: 5%;">
    ...
    <div class="mws-panel-body">
    	<form class="mws-form" action="<?php echo url('/admin/user/upd'); ?>" method="post">
            <input type="hidden" name="id" value="<?php echo $userData['id']; ?>" />
        	<div class="mws-form-inline">
            	<div class="mws-form-row">
                	<label>用户名</label>
                	<div class="mws-form-item large">
                    	<input type="text" class="mws-textinput" name="name"  value="<?php echo $userData['name']; ?>" disabled="true" />
                    </div>
                </div>
            	<div class="mws-form-row">
                	<label>密码</label>
