<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:58:"D:\thinkphp\public/../application/admin\view\news\upd.html";i:1559272631;s:43:"../application/admin/view/index/heater.html";i:1559189204;s:43:"../application/admin/view/index/footer.html";i:1558417309;}*/ ?>
...
<div class="mws-panel grid_7" style="margin-top: 5%;">
    <form class="mws-form" action="<?php echo url('/admin/news/upd'); ?>" method="post" enctype="multipart/form-data">
         <div class="mws-panel grid_8">
                <div class="mws-panel-header">
                    <span class="mws-i-24 i-pencil">编辑文章</span>
                </div>
                        ...
                        <div class="mws-form-inline">
                            <div class="mws-form-row">
                                ...
                                <div class="mws-form-item small">
                                    <input type="text" class="mws-textinput" name="title" value="<?php echo $newsData['title']; ?>"/>
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>图片</label>
                            ...
                            <div class="mws-form-row" style="height: 150px;width: 100%;">
                                <input type="hidden" name="img_path" value="<?php echo $newsData['img']; ?>" />
                                <div class="pic-box" style="background-image:url(/news/<?php echo $newsData['img']; ?>);background-repeat: no-repeat;height: 150px;background-size: 10%;margin-left: 200px;">
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>排序</label>
                                <div class="mws-form-item medium">
                                    <input type="text" class="mws-textinput" name="sort" value="<?php echo $newsData['sort']; ?>"/>
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>内容</label>
                            ...
                            <div class="mws-form-row">
                                ...
                                <div class="mws-form-item clearfix">
                                    <ul class="mws-form-list inline">
                                        <li>
                                            <input type="radio" value="0" name="is_show"  <?php echo $newsData["is_show"]==0?"checked" : ""; ?> />
                                            <label>显示</label>
                                        </li>
                                        <li>
                                            <input type="radio" value="1" name="is_show" <?php echo $newsData["is_show"]==1?"checked" : ""; ?> />
                                            <label>不显示</label>
                                        </li>
                                    </ul>
                                </div>
