<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:62:"D:\thinkphp\public/../application/admin\view\notice\index.html";i:1559271655;s:43:"../application/admin/view/index/heater.html";i:1559286253;s:22:"./data/data_system.php";i:1559190116;s:43:"../application/admin/view/index/footer.html";i:1559286312;}*/ ?>
...
<form action="<?php echo url('/admin/notice/del'); ?>" method="post">
    ...
    <div class="mws-panel-body">
    	<div class="mws-panel-toolbar top clearfix">
        	<ul>
            	...
            	<li><a href="<?php echo url('/admin/notice/add'); ?>" class="mws-ic-16 ic-add">添加</a></li>
            </ul>
        </div>
        <table class="mws-table">
            ...
            <tbody>
                ...
                <tr class="gradeX">
                    ...
                    <td ><img src="/Notice/<?php echo $v['img']; ?>" style="height: 40px;"></td>
                     <td><?php echo $v["sort"]; ?></td>
                    <td class="status"><?php echo $v["is_show"]==0?"已显示":"<span style='color: red;'>已隐藏</span>"; ?></td>
                    <td><?php echo date("Y-m-d H:i:s",$v["time"]); ?></td>
                    <td class="center">
                    	<div class="mws-panel-toolbar top clearfix">
                    	    <ul>
                            	<li><a href="<?php echo url('/admin/notice/upd',['id' => $v['id']]); ?>" class="mws-ic-16 ic-edit">编辑</a></li>
                                 <li class="titles"  onclick="titles(this);" id="<?php echo $v['id']; ?>">
                                    <?php echo $v["is_show"]==0?"<a href='#' class='mws-ic-16 ic-cross' >首页显示</a>" : "<a href='#' class='mws-ic-16 ic-accept'>首页隐藏</a>"; ?>
                                </li>
                            	<li class="titles" id="<?php echo $v['id']; ?>">
                                   <a href="<?php echo url('/admin/notice/del',['id' => $v['id']]); ?>" class='mws-ic-16 ic-cross'>删除</a>
                                </li>
                            </ul>
                        </div>
                    </td>
...
<script type="text/javascript">
    ...
    function titles(it){
        var id = $(it).attr('id');
        // console.log(id);
        $.get("<?php echo url('/admin/notice/is_show'); ?>",{"id":id},function(e){
            // console.log(e);
            if(e.code==1){
                //1表示封号成功
